...
import edu.bodega.yessy.back_sol.dto.auth.ForgotPasswordRequest;
import edu.bodega.yessy.back_sol.dto.auth.ResetPasswordRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> forgotPassword(@RequestBody ForgotPasswordRequest request) {
        ...
        return ResponseEntity.ok(Map.of("mensaje", "Si el correo existe, se ha enviado un enlace de recuperación."));
    }
