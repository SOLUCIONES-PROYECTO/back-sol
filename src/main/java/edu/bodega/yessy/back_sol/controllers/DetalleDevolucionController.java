...
@RestController
@RequestMapping("/detalledevolucion")
public class DetalleDevolucionController {
    ...
    @GetMapping
    public ArrayList<DetalleDevolucion> listarDetalleDevolucion() {
        return detalleDevolucionService.listar();
    }

    @PostMapping
    public DetalleDevolucion nuevoDetalleDevolucion(
            @RequestBody DetalleDevolucion detalleDevolucion) {
