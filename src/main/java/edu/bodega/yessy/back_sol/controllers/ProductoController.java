...
public class ProductoController {
    ...
    public ProductoResponseDTO nuevoProducto(
        ...
        ProductoResponseDTO response = productoService.nuevo(dto);
        auditoriaService.registrarAccion("Productos", "CREAR", "Se creó el producto: " + dto.getNombre());
        return response;
    }
    ...
    public ProductoResponseDTO actualizarProducto(
        ...
        auditoriaService.registrarAccion("Productos", "ACTUALIZAR", "Se actualizó el producto ID: " + id);
        return response;
    }
    ...
    public ResponseEntity<?> eliminarProducto(@PathVariable Integer id) {
        try {
            ...
            auditoriaService.registrarAccion("Productos", "ELIMINAR", "Se eliminó el producto ID: " + id);
