...
public class DocSalidaService {
    ...
    private DocSalidaResponseDTO convertirDTO(DocSalida docSalida) {
        ...
        dto.setCliente(docSalida.getCliente().getPersona().getNombre() + " " + docSalida.getCliente().getPersona().getApellido());
        dto.setEmpleado(docSalida.getEmpleado().getPersona().getNombre() + " " + docSalida.getEmpleado().getPersona().getApellido());
